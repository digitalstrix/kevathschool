          ...
          <div className="prof-sec112">
            ...
            <form onSubmit={submitHandle1}>
              ...
              <div className="psi-btn">
                <div className="row">
                  <button type="button" className="btn btn1 btn4 btn0">
                    Cancel
                  </button>
            ...
            <div>
              <p>
                Passwords must have a Good or Strong rating. Passwords must be
                at least 6 characters long. Good passwords contain either a
                combination of uppercase and lowercase letters or a combination
                of letters and one digit. Strong passwords contain either a
                combination of letters and more than one digit or special
                characters.
              </p>
            </div>
          </div>
